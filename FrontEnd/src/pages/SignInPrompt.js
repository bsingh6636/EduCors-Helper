...
const SignInPrompt = () => {
  ...
  return (
    <div className="min-h-screen  flex items-center  bg-gray-950 justify-center p-6">
      <div className="max-w-lg mx-auto bg-gray-900 rounded-lg shadow-lg p-6 text-center">
